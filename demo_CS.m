...
Xs_input = Xs_CS;
%% Reference
Xs0_input = [-20,0;0,20;20,0];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Please smooth Xs0_input or plan trajectory here
% Assume that you get kappa0_output here, i.e., the distribution of curvature along toolpaths
% TODO
% Output: Xs0_output and kappa0_output
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
